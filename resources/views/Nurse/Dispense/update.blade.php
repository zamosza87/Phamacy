    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body" id="card-pha">
                                            ...
                                            <div class="form-inline pha-{{ $data->pha_id }}">
                                                    ...
                                                    <div class="col-6">
                                                    <input type="number" class="form-control" name="pha[{{ $value->pha_id }}]" value="{{ $value->amount }}" min="1" required/>
                                                    </div>
            ...
            <div class="modal fade addPhama" tabindex="-1" role="dialog" aria-labelledby="plusPhama" id="plusPhama" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" id="dialog-M">
